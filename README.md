...
| Publisher hub audit | The official SAGE CFP hub is checked during dated human audits. | The hub reported no live Communication & Media calls on August 10, 2026, but blocks GitHub-hosted runners; it is therefore not claimed as unattended publisher-wide coverage. The separately verified Communication and the Public proposal remains necessary. |
...
| Journal CFP page | Personal Relationships (Wiley) was checked through its official CFP listing on August 10, 2026. | The page contains only expired 2024 calls and blocks GitHub-hosted runners, so it is not an active unattended source. |
| Direct publisher pages | Journal of Public Relations Research is checked directly as a supplemental Taylor & Francis source. | The closed Health Communication call was retired on August 10, 2026; the publisher API remains the broader source. |
...
- SAGE's official CFP hub reports no live Communication & Media calls as of August 10, 2026, but returns 403 to GitHub-hosted runners. Its 20 configured journals, including Cyberpsychology, Behavior, and Social Networking, are not currently claimed as publisher-wide automated CFP coverage. Communication and the Public is retained as a separately verified PDF proposal call and is not part of the 70-journal article registry.
